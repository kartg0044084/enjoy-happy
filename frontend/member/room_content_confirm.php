  ...
  <?php require_once("../template/header2.php"); ?>
    ...
    <form action="order_success.php" method="post" data-toggle="validator">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <label for="totalprice" id="totalprice" name="totalprice" class="control-label"><?php $totalprice= $attractionsprice+ $service_charge + $totaldateprice; echo $totalprice; ?>元</label>
          <div class="help-block with-errors"></div>
        </div>
      </div>
      <!--$_POST總金額 以傳送 -->
